...
class EmissiveLightingModel(LightningModule):
    ...
    def render(self, lighting_model, material, geometry, image=None):
        albedo = material.albedo.clamp(0, 1) #[1,3,480,640]
        rough = material.roughness.clamp(0, 1) #[1,1,480,640]
        metal = material.metallic.clamp(0, 1) #[1,1,480,640]

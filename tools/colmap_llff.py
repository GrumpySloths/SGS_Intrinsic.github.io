...
def pipeline(scene, base_path, n_views):
    ...
    os.system( 'colmap exhaustive_matcher --database_path database.db --SiftMatching.use_gpu 0 --SiftMatching.guided_matching 1 --SiftMatching.max_num_matches 32768')
...
#     pipeline(scene, base_path = '/mnt/data0/jiahao/datasets/nerf_llff_data/', n_views = 3)  # please use absolute path!

for scene in ['flower', 'fortress', 'horns',  'leaves',  'orchids', 'trex']:
    pipeline(scene, base_path = '/mnt/data0/jiahao/datasets/nerf_llff_data/', n_views = 3)  # please use absolute path!

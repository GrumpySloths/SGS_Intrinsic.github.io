...
if __name__ == "__main__":
    ...
    # ]
    input_paths=[
        "/home/jiahao/ipsm_relighting_v5/DL3DV-Evaluation/images_tar/indoor_scene0/gaussian_splat/images_4/frame_00014.png"
    ]
    ...
    # aov_result= sd_estimate_aovs(photos[0], inference_step=50).cpu().numpy()  # [3, H, W]
    ...
    for i, aov_tensor in enumerate(aov_results):
        ...
        output_path = f"test_rgb2x/albedo_dl3dv_{i}.png"
